        ...
        <table class="table table-dark table-striped">
          ...
          <tbody>
            ...
            <tr>
             ...
             <td> <a  href="./frmEditar.php?id=<?php echo $datos[0]?>" type="button" class="btn btn-info"  class="bi bi-pencil-square"><i class="bi bi-pencil-square"> </i></a> </td>
             <td> <a href="#"type="button" class="btn btn-danger" class="bi bi-trash"><i class="bi bi-trash"></i></a> </td>
